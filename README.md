...
![My Skills](https://skillicons.dev/icons?i=js,ts,python,rails,solidity,rust,nodejs,nestjs,react,angular,vue,flask,fastapi,aws,azure,gcp,docker,linux,mysql,postgres,mongodb,nginx,github)
<!--
